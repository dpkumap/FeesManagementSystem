...
public class UpdateFeesDetails extends javax.swing.JFrame {
    ...
    public String updateData()
    {
        ...
        try
        {
            ...
            PreparedStatement pst=con.prepareStatement("update fees_details set student_name=?,roll_no=?,payment_mode=?,"
                    ...
                    + "amount=?,cgst=?,sgst=?,total_in_words=?,remark=?,year1=?,year2=? where reciept_no=?");//these are column names
           
          
            pst.setString(1,studentName); // 1=QuestionMark,recieptNo=DB column name
    ...
    public void setRecords()
    {
        try
        {
            ...
            ResultSet rs=pst.executeQuery();
            rs.next();
            //Below Line All data is came just we have to set that data to their respective TextFields
            ...
            txt_bankName.setText(rs.getString("bank_name"));//Here in rs.getString() method we putting DB Names
            txt_recievedFrom.setText(rs.getString("student_name"));
            dateChooser.setDate(rs.getDate("date"));
            txt_year1.setText(rs.getString("year1"));// We can get int values of year column in DB 
            txt_year2.setText(rs.getString("year2"));// IN String Format
    ...
    private void initComponents() {
        ...
        jSeparator1.setForeground(new java.awt.Color(27, 27, 27));
        panelChild.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, 730, 30));

        jSeparator2.setForeground(new java.awt.Color(27, 27, 27));
        ...
        jSeparator3.setForeground(new java.awt.Color(27, 27, 27));
        ...
        jSeparator4.setForeground(new java.awt.Color(27, 27, 27));
